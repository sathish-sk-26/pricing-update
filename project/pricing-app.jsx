...
const App = () => {
  ...
  const [saveImpactOpen, setSaveImpactOpen] = useState(false);
  const onSave = () => {
    setSaved(true);
    ping("Changes saved.");
  ...
  return (
    <>
      ...
      <div className={`page${!tweaks.showMandatorySteps ? " page--published" : ""}`}>
        ...
        <main className="main-card" data-comment-anchor="4ba964bc17-main-265-9">
          ...
          <div className="page-footer">
            ...
            <button className="btn btn-primary" onClick={() => setSaveImpactOpen(true)}>Save</button>
          </div>
        </main>
      ...
      <SaveImpactModal
        ...
        trialOn={trialOn}
        trialDays={trialDays}
        onConfirm={() => { setSaveImpactOpen(false); onSave(); }}
        onClose={() => setSaveImpactOpen(false)} />
